 ...
 * main.cpp
 * 
 * Reads in 10 random strings from the user, 
 * then sorts them in alphabetical order, and prints them sorted. 
 * 
 */
 ...
 *
 * Prompts the user to enter 10 strings.
 * Prints the entered strings.
...
int main() {
    ...
    cout << "Please enter " << size << " strings" << endl; // Print a message prompting the user to enter 10 strings
    for (int i = 0; i < size; i++) { // Loop through each element of the array
        cout << "Enter string " << i + 1 << ": "; // Print a message prompting the user to enter a string
        cin >> arr[i]; // Read a string from the user and assign it to the current array element
        cout << "You entered: " << arr[i] << endl; // Print the string entered by the user
    }
